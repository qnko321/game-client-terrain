...
//
// use log::*;
// use nalgebra_glm::{is_null, sign};
//
// use vulkanalia::vk::{ClearValue, ExtDebugUtilsExtension, MemoryRequirements};
...
// }
//
// /// The Vulkan handles the associated properties used by our Vulkan app.
...
//         .polygon_mode(vk::PolygonMode::FILL) // TODO: Experiment by changing the value (requires enabling a GPU feature)
//         .line_width(1.0)
